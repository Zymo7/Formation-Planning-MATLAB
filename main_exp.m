...
%% 读取地图并初始化参数
figure
% mapOriginal=imbinarize(imread('Maps/map_new_circle.bmp')); %从bmp文件读取地图
mapOriginal=imbinarize(imread('Maps/map_exp.bmp')); %从bmp文件读取地图
...
des = [0,0; 4,0; 4,-4; 0,-4] + [1,1;1,1;1,1;1,1;];
